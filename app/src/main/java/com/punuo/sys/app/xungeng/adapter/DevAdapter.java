...
import com.punuo.sys.app.xungeng.ui.VideoPlay;
                        ...
                        try {
                            ...
                            if (SipInfo.queryResponse) {
                                Message invite = SipMessageFactory.createInviteRequest(SipInfo.sipUser,
                                        SipInfo.toDev, SipInfo.user_from, BodyFactory.createMediaBody(VideoInfo.resultion,"H.264","G.711",SipInfo.query));
                                outer2:
                                for (int i = 0; i < 3; i++) {
